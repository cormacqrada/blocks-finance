    ...
    // === Margin of Safety Screens ===
    {
      ...
      logic: {
        ...
        parameters: {
          ...
          rank_by: "pe_ratio",
          rank_order: "ASC",
          columns: ["ticker", "price", "pe_ratio", "ev_to_fcf", "pb_ratio", "eps", "book_value_per_share"],
    ...
    // === Quality + Value Screen ===
    {
      ...
      logic: {
        ...
        parameters: {
          ...
          rank_order: "DESC",
          columns: ["ticker", "price", "pe_ratio", "ev_to_fcf", "gross_margin", "operating_margin", "debt_to_equity"],
    ...
    // === Torque / Turnaround Screen ===
    {
      ...
      logic: {
        ...
        parameters: {
          ...
          rank_order: "DESC",
          columns: ["ticker", "price", "pe_ratio", "ev_to_fcf", "eps_growth_yoy", "revenue_growth_yoy", "free_cash_flow"],
    ...
    // === Dividend Value Screen ===
    {
      ...
      logic: {
        ...
        parameters: {
          ...
          rank_order: "DESC",
          columns: ["ticker", "price", "dividend_yield", "payout_ratio", "pe_ratio", "ev_to_fcf", "debt_to_equity"],
          formulas: [],
          limit: 20,
        },
      },
